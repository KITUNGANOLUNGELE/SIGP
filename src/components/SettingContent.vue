<template>
  <q-layout view="hHh lpR fFf">
    <div class="q-mx-md">
      <h1 class="text-weight-medium">Paramètre Administrateur</h1>
      <q-breadcrumbs>
    ...
    <div class="q-pa-sm">
      <ul class="box-info q-pa-md">
        <li class="aos-item" data-aos="zoom-in-right">
          <!-- <q-icon class="bx" name="manage_accounts" /> -->
          <span class="text">
        ...
        <li class="aos-item" data-aos="zoom-in">
          ...
          <span class="text">
            <h3>Menu Rapport Utilisateurs par Catégorie de Rôle</h3>
            <RoleUser />
          </span>
        </li>
      </ul>
...
<script>
import { ref } from "vue";
import UserAccess from "src/components/UserAccess.vue";
import RoleUser from "src/components/RoleUser.vue";

import AOS from "aos";
import "aos/dist/aos.css";

export default {
  components: { UserAccess, RoleUser },

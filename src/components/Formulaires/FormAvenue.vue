  ...
  <q-layout view="hHh lpR fFf">
    ...
    <ul class="box-info q-pa-md">
      <li class="aos-item" data-aos="zoom-in-right">
        ...
        <span class="text">
          <h3>{{store.getAvenues}}</h3>
          <p> Avenues Ajoutées</p>
        </span>
      </li>
    ...
    <q-dialog v-model="dialog" :position="position">
      <q-card style="width: 350px">
        ...
        <q-card-section class="text-center q-pa-md">
          <div class="text-weight-bold">Ajouter une avenue</div>
    ...
    <div class="q-pa-md">
      ...
      <q-markup-table>
        <thead>
          <tr>
            <th class="text-left">Id avenue</th>
            <th class="text-left">designation avenue</th>
          </tr>
        </thead>
        <tbody>
          <tr :key="index" v-for="(avenue, index) in avenues">
            <td class="text-left">{{ avenue.id }}</td>
            <td class="text-left">{{ avenue.nom_avenue }}</td>
...
export default {
  ...
  methods:{
    submitForm(){
      const xAvenue={
        'nomAvenue':this.nom_avenue,
        'quartier': this.id_quartier
      }
      this.store.ajoutAvenue(xAvenue.nomAvenue,xAvenue.quartier);
    },
  },
};
</script>

      ...
      <q-markup-table>
        <thead>
          <tr>
            ...
            <th class="text-left">designation groupement</th>
          </tr>
        </thead>
        <tbody>
          <tr :key="index" v-for="(groupement, index) in groupements">
            <td class="text-left">{{ groupement.id }}</td>
            <td class="text-left">{{ groupement.nom_groupement }}</td>
...
export default {
  ...
  setup() {
    ...
    const groupements=computed(()=>{
      return store.groupements;
    });
    onMounted(()=>{

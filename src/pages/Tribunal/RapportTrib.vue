...
<script>
import { ref } from "vue";
import SideBar from "src/components/Etat/SideBar.vue";
import InAside from "src/components/Tribunal/InAside.vue";
import RapportTrib from "src/components/Tribunal/RapportTrib.vue";

export default {
  data() {
    return {};
  },
  components: { SideBar, InAside, RapportTrib },
  setup() {

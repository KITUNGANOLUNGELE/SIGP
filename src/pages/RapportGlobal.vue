...
import AsideInBar from "src/components/AsideInBar.vue";
import RapportContent from "src/components/RapportContent.vue";
import MenuBar from "src/components/MenuBar.vue";

export default {
  components: { SideBar, AsideInBar, AsideInBar, RapportContent, MenuBar },
  setup() {
